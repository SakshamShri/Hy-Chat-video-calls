        ...
        <div className="card-body p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Favourite Singer</span>
                </label>
                <select
                  name="learningLang"
                  ...
                  className="select select-bordered w-full"
                >
                  <option value="">Select favourite singer</option>
                  {SINGERS.map((singer) => (
                    <option key={`learning-${singer}`} value={singer}>
                      {singer}
                    </option>
                  ))}
                </select>
            ...
            >
              {!isPending ? (
                <>
                  <RoseIcon className="size-5 mr-2" />
                  Complete Onboarding
                </>
              ) : (
                <>
